.class Lcom/tcl/uniplayer_iptv/xtream/db/LoginInfoDao_Impl$3;
.super Lx0/b;
.source "SourceFile"
...
.method public constructor <init>(Lcom/tcl/uniplayer_iptv/xtream/db/LoginInfoDao_Impl;Lx0/j;)V
    ...
    iput-object p1, p0, Lcom/tcl/uniplayer_iptv/xtream/db/LoginInfoDao_Impl$3;->this$0:Lcom/tcl/uniplayer_iptv/xtream/db/LoginInfoDao_Impl;
...
.method public bind(La1/f;Lcom/tcl/uniplayer_iptv/xtream/bean/LoginInfo;)V
    ...
    .line 46
    iget-object v2, v11, Lcom/tcl/uniplayer_iptv/xtream/db/LoginInfoDao_Impl$3;->this$0:Lcom/tcl/uniplayer_iptv/xtream/db/LoginInfoDao_Impl;
...
.method public bridge synthetic bind(La1/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/tcl/uniplayer_iptv/xtream/db/LoginInfoDao_Impl$3;->bind(La1/f;Lcom/tcl/uniplayer_iptv/xtream/bean/LoginInfo;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR REPLACE `LoginInfo` SET `id` = ?,`title` = ?,`serverAddress` = ?,`username` = ?,`password` = ?,`uuid` = ?,`liveStreamSize` = ?,`vodStreamSize` = ?,`seriesStreamSize` = ?,`message` = ?,`auth` = ?,`status` = ?,`expDate` = ?,`isTrial` = ?,`activeCons` = ?,`createdAt` = ?,`maxConnections` = ?,`allowedOutputFormats` = ?,`xui` = ?,`version` = ?,`revision` = ?,`url` = ?,`port` = ?,`httpsPort` = ?,`serverProtocol` = ?,`rtmpPort` = ?,`timestampNow` = ?,`timeNow` = ?,`timezone` = ? WHERE `id` = ?"
