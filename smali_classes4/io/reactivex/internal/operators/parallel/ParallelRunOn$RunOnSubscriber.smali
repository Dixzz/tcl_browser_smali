...
# direct methods
.method public constructor <init>(Lhe/c;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/Scheduler$Worker;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lhe/c;
...
.method public onSubscribe(Lhe/d;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lhe/d;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lhe/d;

    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lhe/c;
...
.method public run()V
    ...
    .line 3
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnSubscriber;->downstream:Lhe/c;
    ...
    .line 11
    invoke-interface {v3, v15}, Lhe/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 16
    :cond_6
    invoke-interface {v3, v15}, Lhe/c;->onNext(Ljava/lang/Object;)V
    ...
    .line 17
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lhe/d;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lhe/d;->request(J)V
