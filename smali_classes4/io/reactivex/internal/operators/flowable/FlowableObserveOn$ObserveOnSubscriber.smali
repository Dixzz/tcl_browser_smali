...
# direct methods
.method public constructor <init>(Lhe/c;Lio/reactivex/Scheduler$Worker;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lhe/c;
...
.method public onSubscribe(Lhe/d;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lhe/d;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lhe/d;
    ...
    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lhe/c;
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lhe/c;
...
.method public poll()Ljava/lang/Object;
    ...
    .line 6
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lhe/d;

    invoke-interface {v3, v1, v2}, Lhe/d;->request(J)V
...
.method public runAsync()V
    ...
    .line 7
    :goto_2
    invoke-virtual {p0, v9, v11, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLhe/c;)Z
    ...
    .line 8
    :cond_4
    invoke-interface {v0, v10}, Lhe/c;->onNext(Ljava/lang/Object;)V
    ...
    .line 11
    :cond_5
    iget-object v8, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lhe/d;

    invoke-interface {v8, v2, v3}, Lhe/d;->request(J)V
    ...
    .line 16
    invoke-interface {v0, v2}, Lhe/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v6, v7, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLhe/c;)Z
...
.method public runBackfused()V
    ...
    .line 3
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lhe/c;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Lhe/c;->onNext(Ljava/lang/Object;)V
    ...
    .line 6
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnSubscriber;->downstream:Lhe/c;

    invoke-interface {v1, v0}, Lhe/c;->onError(Ljava/lang/Throwable;)V
...
.method public runSync()V
    ...
    .line 10
    :cond_2
    invoke-interface {v0, v8}, Lhe/c;->onNext(Ljava/lang/Object;)V
    ...
    .line 13
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lhe/d;

    invoke-interface {v2}, Lhe/d;->cancel()V
