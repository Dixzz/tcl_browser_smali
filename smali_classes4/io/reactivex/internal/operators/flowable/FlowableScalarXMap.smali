...
.method public static tryScalarXMapSubscribe(Lhe/b;Lhe/c;Lio/reactivex/functions/Function;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {p2, p1, p0}, Lio/reactivex/internal/subscriptions/ScalarSubscription;-><init>(Lhe/c;Ljava/lang/Object;)V

    invoke-interface {p1, p2}, Lhe/c;->onSubscribe(Lhe/d;)V
    ...
    .line 10
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Lhe/c;)V

    return v0

    .line 11
    :cond_2
    invoke-interface {p0, p1}, Lhe/b;->subscribe(Lhe/c;)V
