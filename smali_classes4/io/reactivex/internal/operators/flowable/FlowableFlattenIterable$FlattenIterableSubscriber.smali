...
# direct methods
.method public constructor <init>(Lhe/c;Lio/reactivex/functions/Function;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lhe/c;
...
.method public cancel()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lhe/d;
...
.method public checkTerminated(ZZLhe/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    .line 8
    invoke-interface {p3, p1}, Lhe/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 9
    invoke-interface {p3}, Lhe/c;->onComplete()V
...
.method public drain()V
    ...
    .line 2
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lhe/c;
    ...
    .line 8
    :goto_2
    invoke-virtual {v1, v9, v11, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLhe/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    .line 15
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lhe/d;

    invoke-interface {v3}, Lhe/d;->cancel()V
    ...
    .line 18
    invoke-interface {v2, v0}, Lhe/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 20
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lhe/d;
    ...
    invoke-virtual {v1, v15, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLhe/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    .line 29
    invoke-interface {v2, v5}, Lhe/c;->onNext(Ljava/lang/Object;)V

    .line 30
    iget-boolean v5, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    invoke-virtual {v1, v5, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLhe/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    .line 48
    :goto_6
    invoke-virtual {v1, v5, v15, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLhe/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
...
.method public onSubscribe(Lhe/d;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lhe/d;
    ...
    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lhe/c;
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lhe/c;
