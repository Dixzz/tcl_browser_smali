...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    .line 2
    invoke-interface {v0, p2, p3}, Lhe/d;->request(J)V
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lhe/d;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lhe/d;)Z
    ...
    .line 3
    invoke-interface {p2, p0, p1}, Lhe/d;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lhe/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static reportMoreProduced(J)V
    ...
    .line 2
    invoke-static {v1, p0, p1}, La8/l;->c(Ljava/lang/String;J)Ljava/lang/String;
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lhe/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lhe/d;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lhe/d;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lhe/d;)Z
    ...
    .line 7
    invoke-interface {p1, p2, p3}, Lhe/d;->request(J)V
...
.method public static validate(Lhe/d;Lhe/d;)Z
    .locals 1
