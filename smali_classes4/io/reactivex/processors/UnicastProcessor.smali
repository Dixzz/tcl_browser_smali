...
# virtual methods
.method public checkTerminated(ZZZLhe/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p1}, Lhe/c;->onError(Ljava/lang/Throwable;)V
    ...
    .line 11
    :cond_2
    invoke-interface {p4}, Lhe/c;->onComplete()V
...
.method public drain()V
    ...
    .line 4
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Lhe/c;)V

    goto :goto_1

    .line 5
    :cond_1
    invoke-virtual {p0, v1}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Lhe/c;)V
...
.method public drainFused(Lhe/c;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 10
    :cond_2
    invoke-interface {p1, v4}, Lhe/c;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Lhe/c;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLhe/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    .line 7
    invoke-interface {v5, v8}, Lhe/c;->onNext(Ljava/lang/Object;)V
