.class public final Lcom/google/common/collect/y0$z;
...
.method public constructor <init>(Lcom/google/common/collect/y0;II)V
    ...
    iput-object p1, p0, Lcom/google/common/collect/y0$z;->queueForKeys:Ljava/lang/ref/ReferenceQueue;

    return-void
.end method

.method public static synthetic access$200(Lcom/google/common/collect/y0$z;)Ljava/lang/ref/ReferenceQueue;
    .locals 0

    iget-object p0, p0, Lcom/google/common/collect/y0$z;->queueForKeys:Ljava/lang/ref/ReferenceQueue;
...
.method public bridge synthetic castForTesting(Lcom/google/common/collect/y0$i;)Lcom/google/common/collect/y0$i;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/google/common/collect/y0$z;->castForTesting(Lcom/google/common/collect/y0$i;)Lcom/google/common/collect/y0$y;
...
.method public castForTesting(Lcom/google/common/collect/y0$i;)Lcom/google/common/collect/y0$y;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    check-cast p1, Lcom/google/common/collect/y0$y;
...
.method public getKeyReferenceQueueForTesting()Ljava/lang/ref/ReferenceQueue;
    ...
    iget-object v0, p0, Lcom/google/common/collect/y0$z;->queueForKeys:Ljava/lang/ref/ReferenceQueue;
...
.method public bridge synthetic self()Lcom/google/common/collect/y0$n;
    ...
    invoke-virtual {p0}, Lcom/google/common/collect/y0$z;->self()Lcom/google/common/collect/y0$z;
...
.method public self()Lcom/google/common/collect/y0$z;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
