.class public final Lcom/tcl/browser/iptv/fragment/WebVideoFragment;
...
.method public final T0(Ljava/util/ArrayList;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/tcl/browser/iptv/fragment/WebVideoFragment;->Y:Lqb/a0;
    ...
    invoke-direct {v0, p1}, Lqb/a0;-><init>(Ljava/util/ArrayList;)V

    iput-object v0, p0, Lcom/tcl/browser/iptv/fragment/WebVideoFragment;->Y:Lqb/a0;

    .line 9
    invoke-virtual {v0, p0}, Lqb/a0;->setOnDeleteWebListener(Lja/e;)V
...
.method public final U0()V
    ...
    .line 1
    iget-boolean v0, p0, Lcom/tcl/browser/iptv/fragment/WebVideoFragment;->Z:Z
    ...
    .line 5
    iput-boolean v0, p0, Lcom/tcl/browser/iptv/fragment/WebVideoFragment;->Z:Z
...
.method public final k(Ljava/lang/Object;)V
    ...
    .line 1
    check-cast p1, Lcom/tcl/browser/model/data/kotlin/DeleteWebVideoInfo;
    ...
    .line 3
    iget-object v1, v0, Lqb/a0;->f:Ljava/util/ArrayList;
    ...
    .line 4
    iget-object v3, v0, Lqb/a0;->f:Ljava/util/ArrayList;
    ...
    .line 6
    :cond_0
    invoke-virtual {p1}, Lcom/tcl/browser/model/data/kotlin/DeleteWebVideoInfo;->getMWebVideoInfo()Lcom/tcl/browser/model/data/kotlin/VideoInfoTable;
    ...
    invoke-virtual {p1}, Lcom/tcl/browser/model/data/kotlin/VideoInfoTable;->getId()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Lcom/tcl/browser/iptv/activity/viewmodel/BookMarkViewModel;->deleteVideoInfoByUrl(J)V

    .line 7
    :cond_1
    iget-object p1, p0, Lcom/tcl/browser/iptv/fragment/WebVideoFragment;->Y:Lqb/a0;

    if-eqz p1, :cond_2

    .line 8
    invoke-virtual {p1}, Lqb/a0;->b()I
    ...
    .line 9
    invoke-virtual {p0}, Lcom/tcl/browser/iptv/fragment/WebVideoFragment;->U0()V
...
.method public final m0()V
    ...
    const-string v0, "WebVideoFragment:onDestroy"
    ...
    invoke-virtual {v0, v1}, Lqb/a0;->setOnDeleteWebListener(Lja/e;)V
...
.method public final n0()V
    ...
    const-string v0, "WebVideoFragment:onDestroyView"
...
.method public final x0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    const-string p1, "WebVideoFragment:onViewCreated"
    ...
    invoke-virtual {p1}, Lcom/tcl/browser/iptv/activity/viewmodel/BookMarkViewModel;->getMGetWebVideoInfoMutable()Lwb/c;
    ...
    invoke-direct {p2, p0, v0}, Lka/k;-><init>(Ljava/lang/Object;I)V
